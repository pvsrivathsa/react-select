   ...
   */
	...
	handleInputFocus: function handleInputFocus(event) {
		...
		if (this.props.onFocus) {
			this.props.onFocus(this.state.inputValue, event);
		}
	},
	...
	handleInputBlur: function handleInputBlur(event) {
		...
		if (this.props.onBlur) {
			this.props.onBlur(this.state.inputValue, event);
		}
	},
	...
	buildMenu: function buildMenu() {
		...
		return ops.length ? ops : React.createElement(
			...
			this.props.asyncOptions && this.state.isLoading ? this.props.searchPromptText : this.props.noResultsText
		);
	},
	...
	render: function render() {
		...
		var tooltip = (this.state.values && this.state.values.length > 0) ? this.state.values[0].label : "";
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'Select-control', ref: 'control', onKeyDown: this.handleKeyDown, onMouseDown: this.handleMouseDown, onTouchEnd: this.handleMouseDown, title: tooltip },
				value,
				input,
